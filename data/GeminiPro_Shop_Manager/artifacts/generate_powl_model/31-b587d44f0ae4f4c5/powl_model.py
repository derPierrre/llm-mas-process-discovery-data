...
select_reward_step = gen.activity("Select Reward (Rewards Team)")
...
# The customer can either select a reward or skip this step.
optional_select_reward = gen.xor(select_reward_step, None)
