...
# Define Activities based on the provided list including the responsible teams
...
process_payment_activity = gen.activity("Process Payment (Payment Processing Team)") # Clarified that reward is included here
