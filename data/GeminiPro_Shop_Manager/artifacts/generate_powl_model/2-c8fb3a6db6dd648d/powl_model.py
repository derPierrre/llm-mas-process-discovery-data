...
# This represents one full attempt to exchange an item.
...
# This means if the exchange process is started, one_exchange_attempt is done at least once, and then can be repeated.
...
# and can be initiated after Item Delivery of the main purchase.
