...
approve_expense_copy = approve_expense.copy()
...
approval_process = gen.partial_order(dependencies=[(approve_expense_copy, initiate_deposit), (initiate_deposit, send_approval_notice)])
