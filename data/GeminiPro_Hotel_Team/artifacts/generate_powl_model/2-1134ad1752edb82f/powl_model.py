...
prep_and_collection_po = gen.partial_order(dependencies=[
    ...
    # No direct order between waiter_collects_food and optional_waiter_collect_alc, allowing concurrency/any order for these two collections.
    # Both waiter_collects_food and optional_waiter_collect_alc must complete before this partial order is considered complete.
])
