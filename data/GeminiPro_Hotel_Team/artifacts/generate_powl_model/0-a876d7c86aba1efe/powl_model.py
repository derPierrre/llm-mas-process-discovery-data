...
# Combined Partial Order for Preparations and Collections
prep_and_collection_po = gen.partial_order(dependencies=[
    (kitchen_prep_food, waiter_collects_food),
    (optional_sommelier_prep, optional_waiter_collect_alc),
    (waiter_prep_cart_non_alc, waiter_collects_food), 
    (waiter_prep_cart_non_alc, optional_waiter_collect_alc),
    (waiter_collects_food, optional_waiter_collect_alc) 
])
