...
# These branches are initiated by the RSM and proceed in parallel.
...
# 1. Order Reception (A0)
# 2. Concurrent Dispatch & Preparation Phase (concurrent_preparation_phase which includes A1-A6 distributed in branches)
# 3. Order Assembly by Waiter (A7)
# 4. Order Delivery by Waiter (A8)
# 5. Payment Processing by Waiter (A9)
# 6. Optional Tipping by Guest (optional_tipping)
